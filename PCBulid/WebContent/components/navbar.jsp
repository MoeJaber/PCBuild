...
<script>
	      ...
	      <ul class="nav navbar-nav navbar-right">
			<li class="dropdown" id="menuLogin">
		        ...
		        <div class="dropdown-menu" style="padding:17px; width: 25em !important;">
		          ...
		          <form action = "http://localhost:8081/PCBulid/LoginServlet" method = "post">
	        ...
	        <li><a href="http://localhost:8081/PCBulid/cart.jsp"><span class="glyphicon glyphicon-shopping-cart"></span> Cart</a></li>
     	  </ul>
	    </div><!-- /.navbar-collapse -->
	  </div><!-- /.container-fluid -->
	</nav>
	...
	<div style="display: none;">
		<div id="inline_content">
			<form class="form-horizontal" role="form" method = "post" action = "http://localhost:8081/PCBulid/RegistrationServlet">
				<fieldset>
