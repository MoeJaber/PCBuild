	...
	<div class="container">
		<h2>
			<a href="../../index.jsp">Home</a> >> <a
				...
				href="psu.jsp">Power Supply Unit</a>
		</h2>
		<p>Showing 2 items in PSU</p>
		<hr>
		<br>
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="panel panel-danger" style="height: 13.5em;">
					<div class="panel-heading"><%=resultSet.getString("psu_name")%><p
							style="font-size: 0.7em;"><%=resultSet.getString("psu_model")%></p>
					</div>
					<div class="panel-body">
						<img src="<%=resultSet.getString("psu_imagepath")%>"
							style="height: 6em;" />
					</div>
					<div class="panel-footer" style="height: 5.35em;">
						...
						<h5>
							$<%=resultSet.getString("psu_price")%></h5>
					</div>
				</div>
			</div>
