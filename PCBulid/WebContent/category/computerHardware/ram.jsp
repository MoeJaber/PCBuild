	...
	<div class="container">
		<h2>
			<a href="../../index.jsp">Home</a> >> <a
				...
				href="memory.jsp">RAM</a>
		</h2>
		<p>Showing 2 items in RAM</p>
		<hr>
		<br>
		<div class="row">
			...
			<%
				try {
					...
					String sql = "SELECT * FROM pc_memory";
			...
			<div class="col-sm-6">
				<div class="panel panel-danger" style="height: 13.5em;">
					<div class="panel-heading"><%=resultSet.getString("memory_name")%><p
							style="font-size: 0.7em;"><%=resultSet.getString("memory_model")%></p>
					</div>
					<div class="panel-body">
						<img src="<%=resultSet.getString("memory_imagepath")%>"
							style="height: 6em;" />
					</div>
					<div class="panel-footer" style="height: 5.35em;">
						...
						<form action = "/PCBulid/AddItemServlet" method = "post">
							...
							<input type="hidden" name="id" value="<%out.print(resultSet.getString("ram_ID"));%>">
							<input type="submit" value="Add to Cart" class="btn pull-right"/>
						</form>
						<h5>
							$<%=resultSet.getString("memory_price")%></h5>
					</div>
				</div>
			</div>
