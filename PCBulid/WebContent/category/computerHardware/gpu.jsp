		...
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="panel panel-danger" style="height: 13.5em;">
					<div class="panel-heading"><%=resultSet.getString("gpu_name")%><p
							style="font-size: 0.7em;"><%=resultSet.getString("gpu_model")%></p>
					</div>
					<div class="panel-body">
						<img src="<%=resultSet.getString("gpu_imagepath")%>"
							style="height: 6em;" />
					</div>
					<div class="panel-footer" style="height: 5.35em;">
						...
						<form action = "/PCBulid/AddItemServlet" method = "post">
							...
							<input type="hidden" name="id" value="<%out.print(resultSet.getString("gpu_ID"));%>">
							<input type="submit" value="Add to Cart" class="btn pull-right"/>
						</form>
						<h5>
							$<%=resultSet.getString("gpu_price")%></h5>
					</div>
				</div>
			</div>
