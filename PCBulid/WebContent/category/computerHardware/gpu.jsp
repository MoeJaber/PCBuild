...
.centered-form{
  ...
  <body>
	...
	<br>
	<div class="container">
<h2><a href = "../../index.jsp">Home</a> >> <a href = "../computerhardware.jsp">Computer Hardware</a> >> <a href = "gpu.jsp">GPU</a></h2>
<hr>
<br>
<div class="row">
	...
	<input type="hidden" name="itemId" value="<%=resultSet.getString("gpuID") %>">
		  <div class="col-sm-6">
		    <div class="panel panel-danger" style = "height: 13.5em;">
		      ...
		      <div class="panel-footer" style = "height: 5.35em;"><span class = "pull-right" style = "color:red;  font-size: 0.8em;">	</span><p style = "text-decoration: line-through; font-size: 0.6em;">	</p><input type="submit" value="More Info" class="btn pull-right" /><button type="button" class="btn pull-right">Add to cart</button><h5>$<%=resultSet.getString("gpuPrice") %></h5></div>
		    </div>
		  </div>
    </form>
