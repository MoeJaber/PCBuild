...
String sql ="SELECT * FROM pc_harddrive where harddrive_ID = '1'";
...
<!-- Overview -->
<p>
 Upgrade virtually every aspect of your computer’s performance with Samsung’s new 850 EVO,
  designed with state-of-the-art SSD advancements including 3D V-NAND technology. 
  As the next generation beyond the bestselling 840 EVO, 
  you’ll get the 850 EVO’s new 3 dimensional chip design that enables superior performance, 
  greater reliability and superior energy efficiency so you can work and play faster and longer than 
  ever before.
</p>
