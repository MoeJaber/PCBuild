	...
	<div class="container">
		<h2>
			<a href="../../index.jsp">Home</a> >> <a
				...
				href="motherboard.jsp">Solid State Drive</a>
		</h2>
		<p>Showing 2 items in SSD</p>
		<hr>
		<br>
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="panel panel-danger" style="height: 13.5em;">
					<div class="panel-heading"><%=resultSet.getString("ssd_name")%><p
							style="font-size: 0.7em;"><%=resultSet.getString("ssd_model")%></p>
					</div>
					<div class="panel-body">
						<img src="<%=resultSet.getString("ssd_imagepath")%>"
							style="height: 6em;" />
					</div>
					<div class="panel-footer" style="height: 5.35em;">
						...
						<form action = "/PCBulid/AddItemServlet" method = "post">
							<input type="hidden" name="category" value="SSD">
							<input type="hidden" name="id" value="<%out.print(resultSet.getString("ssd_ID"));%>">
							<input type="submit" value="Add to Cart" class="btn pull-right"/>
						</form>
						<h5>
							$<%=resultSet.getString("ssd_price")%></h5>
					</div>
				</div>
			</div>
