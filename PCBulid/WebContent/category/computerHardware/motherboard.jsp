	...
	<div class="container">
		<h2>
			<a href="../../index.jsp">Home</a> >> <a
				href="../computerhardware.jsp">Computer Hardware</a> >> <a
				href="motherboard.jsp">Motherboard</a>
		</h2>
		<p>Showing 2 items in Motherboard</p>
		<hr>
		<br>
		<div class="row">
			...
			<%
				try {
					...
					String sql = "SELECT * FROM pc_motherboard";
			...
			<div class="col-sm-6">
				<div class="panel panel-danger" style="height: 13.5em;">
					<div class="panel-heading"><%=resultSet.getString("motherboard_name")%><p
							style="font-size: 0.7em;"><%=resultSet.getString("motherboard_model")%></p>
					</div>
					<div class="panel-body">
						<img src="<%=resultSet.getString("motherboard_imagepath")%>"
							style="height: 6em;" />
					</div>
					<div class="panel-footer" style="height: 5.35em;">
						...
						<form action = "http://localhost:8081/PCBulid/AddItemServlet" method = "post">
							...
							<input type="hidden" name="id" value="<%out.print(resultSet.getString("motherboard_ID"));%>">
							<input type="submit" value="Add to Cart" class="btn pull-right"/>
						</form>
						<h5>
							$<%=resultSet.getString("motherboard_price")%></h5>
					</div>
				</div>
			</div>
